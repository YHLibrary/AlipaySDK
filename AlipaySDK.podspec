...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/YHLibrary/AlipaySDK"
  ...
  s.source       = { :git => "https://github.com/YHLibrary/AlipaySDK.git", :tag => s.version.to_s }
  ...
  # s.resource  = "AlipaySDK/AlipaySDK//icon.png/AlipaySDK.bundle"
